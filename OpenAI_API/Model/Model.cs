...
namespace OpenAI_API.Models
{
	...
	public class Model
	{
		...
		/// recognition as well as speech translation and language identification. 
		/// The Whisper v2-large model is currently available through our API 
		/// with the whisper-1 model name.
		/// Currently, there is no difference between the open source version of Whisper 
		/// and the version available through our API.However, through our API, 
		/// we offer an optimized inference process which makes running Whisper through our 
		/// API much faster than doing it through other means.
		/// </summary>
		...
		/// 8,192 tokens
		/// </summary>
		public static Model gpt_4 => new Model("gpt-4") { OwnedBy = "openai-internal" };
        ...
        /// 8,192 tokens
		/// </summary>
        public static Model gpt_4_0314 => new Model("gpt-4-0314") { OwnedBy = "openai-internal" };

        /// <summary>
        /// Same capabilities as the base gpt-4 mode but with 4x the context length. Will be updated with our latest model iteration.
        /// 32,768 tokens
		/// </summary>
        public static Model gpt_4_32k => new Model("gpt-4-32k") { OwnedBy = "openai-internal" };
        ...
        /// 32,768 tokens
		/// </summary>
        public static Model gpt_4_32k_0314 => new Model("gpt-4-32k-0314") { OwnedBy = "openai-internal" };
