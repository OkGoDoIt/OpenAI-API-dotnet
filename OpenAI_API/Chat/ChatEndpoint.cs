...
namespace OpenAI_API.Chat
{
    ...
    public class ChatEndpoint : EndpointBase
    {
		...
		/// <returns>Asynchronously returns the completion result. Look in its <see cref="ChatResult.Choices"/> property for the results.</returns>
		public Task<ChatResult> CreateChatAsync(ChatMessage[] messages = null,
			Model model = null,
		...
		/// <returns></returns>
		public Task<ChatResult> CreateChatAsync(params ChatMessage[] messages)
		{
			ChatRequest request = new ChatRequest(DefaultChatRequestArgs)
			{
				Messages = messages
		...
		public IAsyncEnumerable<ChatResult> StreamChatEnumerableAsync(ChatMessage[] messages = null,
			Model model = null,
			double? temperature = null,
			double? top_p = null,
			int? numOutputs = null,
